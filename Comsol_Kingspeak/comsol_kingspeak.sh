...
comsol batch -inputfile /uufs/chpc.utah.edu/sys/installdir/comsol/5.5/applications/COMSOL_Multiphysics/Equation_Based/black_scholes_put.mph -outputfile my_test.mph
...
# export TMPDIR /scratch/general/vast/$USER/$SLURM_JOBID
